...
public class FormularioPremiosDTO {
	...
	// Pregunta 11
	private String practicaBienestar; // SI / NO
	...
	public String getPracticaBienestar() {
		return practicaBienestar;
	}

	public void setPracticaBienestar(String practicaBienestar) {
		this.practicaBienestar = practicaBienestar;
	}
	...
	public String obtenerReconocimientoBienestar() {
		if ("SI".equalsIgnoreCase(getReconocidaBienestar()) && getDetalleReconocimientoBienestar() != null
				&& !getDetalleReconocimientoBienestar().isEmpty()) {
